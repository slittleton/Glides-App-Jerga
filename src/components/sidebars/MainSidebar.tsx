...
import { CgProfile, CgMoreO, CgPlayButton } from "solid-icons/cg";
import { IoNotificationsCircleOutline } from "solid-icons/io";
import { RiDesignQuillPenLine, RiMapCompassDiscoverLine } from "solid-icons/ri";
        ...
        <div class="h-full fixed flex-it top-0">
          <div class="flex-it h-full xl:w-80 w-20 overflow-y-auto px-3 justify-between">
            ...
            <div class="flex-it my-3 hover:cursor-pointer">
              ...
              <Popup
                opener={() =>
                  <div class="my-4 flex-it items-center flex-row p-3 rounded-3xl hover:bg-gray-800 hover:rounded-3xl transition duration-200 cursor-pointer">
                    <div class="flex-it">
